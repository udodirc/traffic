    ...
    <div id="header-wrapper" class="container">
		<div id="user-account" class="row" >
			...
			<?php if(Yii::$app->user->identity !== null): ?>
				<div class="ninecol last"><a href="<?=\Yii::$app->request->BaseUrl; ?>/logout"><?= Yii::t('menu', 'Выход'); ?></a> <span>|</span> <a href="<?=\Yii::$app->request->BaseUrl; ?>/partners/profile/<?= \Yii::$app->user->identity->id ?>"><?= Yii::t('menu', 'Профиль'); ?></a> <span>|</span> <span><?= Yii::t('messages', 'Добро пожаловать'); ?>, <strong><?= \Yii::$app->user->identity->login ?>!</strong></span> </div>
			<?php endif; ?>
		</div>
