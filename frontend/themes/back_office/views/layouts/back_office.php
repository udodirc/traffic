						...
						<div class="btn-group">
							<div class="user-settings no-bg">
								<button type="button" class="btn btn-default no-bg micheal_btn" data-toggle="dropdown">
									<?= Html::img(\Yii::getAlias('@web').DIRECTORY_SEPARATOR.Url::to('@backoffice_images'.DIRECTORY_SEPARATOR.'admin.jpg'), ['alt'=>'avatar', 'class'=>'admin_img2 img-thumbnail rounded-circle avatar-img']) ?>
									<strong>
