...
$this->registerJsFile(Yii::$app->request->baseUrl.'vendors/bower_components/bootstrap/dist/js/bootstrap.min.js',['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl.'dist/js/dropdown-bootstrap-extended.js',['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl.'dist/js/jquery.slimscroll.js',['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl.'vendors/bower_components/owl.carousel/dist/owl.carousel.min.js',['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl.'vendors/bower_components/switchery/dist/switchery.min.js',['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl.'dist/js/init.js"',['depends' => [\yii\web\JqueryAsset::className()]]);
