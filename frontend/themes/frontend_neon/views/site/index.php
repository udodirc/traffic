...
$this->registerCssFile(Yii::$app->request->baseUrl.'/frontend/themes/frontend_neon/assets/css/font-icons/font-awesome/css/font-awesome.min.css');
$this->registerCssFile(Yii::$app->request->baseUrl.'/frontend/themes/frontend_neon/assets/css/count_down/jquery.countdown.css');
$this->registerJsFile(Yii::$app->request->baseUrl.'/frontend/themes/frontend_neon/assets/js/count_down/jquery.plugin.min.js',['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl.'/frontend/themes/frontend_neon/assets/js/count_down/jquery.countdown.js',['depends' => [\yii\web\JqueryAsset::className()]]);
...
$inlineScript = "$(function () {
	$('#count_down').countdown({until: new Date(2018, 11, 27)});
});";
...
<section class="contact-container index">
        <div class="container">
			...
			<div class="col-sm-12">
				<h2 style="text-align:center"><span style="font-size:40px"><span style="color:#FF0000"><strong><?= (isset($counterContent)) ? $counterContent : ''; ?></strong></span></span></h2>
			</div>
                        ...
                        <div class="col-sm-12">
                                <div class="main-content">
                                        <?= (isset($staticContent)) ? $staticContent : ''; ?>
                                </div>
                        </div>
                </div>
        </div>
