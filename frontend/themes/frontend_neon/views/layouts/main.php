...
$this->registerJsFile(Yii::$app->request->baseUrl.'/frontend/themes/frontend_neon/assets/js/bootstrap.js',['depends' => [\yii\web\JqueryAsset::className()]]);
$this->registerJsFile(Yii::$app->request->baseUrl.'/frontend/themes/frontend_neon/assets/js/neon-custom.js',['depends' => [\yii\web\JqueryAsset::className()]]);
?>
<?php $this->beginPage() ?>
<!DOCTYPE html>
