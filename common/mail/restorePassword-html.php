...
<table style="width:500px; height:600px; background:#eee; border:0;" cellspacing="0" cellpadding="0">
	<tr>
		...
		<td style="vertical-align:top;">
			<p>Good day, <span style="color:#002857;"><?= $username ?>!</span></p>
			...
			<p>To changing of password follow this link&nbsp;<a href="<?= $site ?>/restore/<?= $user_id ?>/<?= $hash ?>"><?= $site ?>/restore/<?= $user_id ?>/<?= $hash ?></a></p>
			<br />
