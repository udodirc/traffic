			...
			<div id="matrix-by-level">
				<table class="table table-striped table-bordered">
					...
					<tr>
						...
						<td>
							<?= Html::a('<span class="glyphicon glyphicon-eye-open"></span>', \Yii::$app->request->BaseUrl.'/partners/matrix-by-id/'.$structure_number.'/'.$matrix.'/'.$demo.'/'.$matrixData['id'].'/'.$matrixData['partner_id'], [
