...
<div id="list-matrix">
	<table class="table table-striped table-bordered">
		...
		<tr>
			...
			<td>
				<?= Html::a('<span class="glyphicon glyphicon-eye-open"></span>', \Yii::$app->request->BaseUrl.'/backoffice/backend-partners/matrix-level?structure='.$structureNumber.'&matrix='.$matrixNumber.'&demo='.$demo.'&id='.$matrixID.'&level='.$level, [
