...
<body>
	...
	<div class="cont">
		...
		<div class="total_amount left">
			<?= ($status > 0) ? '' : Yii::t('form', 'у вас на счету:&nbsp;<span class="status_view">$').$totalAmount.'</span> - '.Html::a(Yii::t('form', 'подробнее'), 'matrices', []); ?>
		</div>
	...
	<div class="cont backoffice">
		<div id="left-menu">
			...
			<aside class="right">
				<div class="account">
					<div class="info">
						<div class="avatar left"><?= Html::img(\Yii::getAlias('@web').DIRECTORY_SEPARATOR.Url::to('@frontend_images'.DIRECTORY_SEPARATOR.'avatar.png'), ['alt'=>'']) ?></div>
						<div class="name">Здравствуйте, <?= (\Yii::$app->user->identity->first_name != '') ? \Yii::$app->user->identity->first_name : ''?>!</div>
						<div class="email"><?= ($status > 0) ? Yii::t('messages', 'Ваш статус <span class="status_view">активен</span>!') : Yii::t('messages', 'Ваш статус <span class="status_view">не активен</span>!'); ?><br/></div>
						<div class="clear"></div>
					</div>
					<a href="#" class="menu_link"><span>1</span></a>
					<?= MenuWidget::widget([
	...
	<footer>
		...
		<div class="cont">
			...
			<div class="quiestion">
				...
				<div class="link"><a href="#" class="feedback">Написать нам</a></div>
			</div>		
