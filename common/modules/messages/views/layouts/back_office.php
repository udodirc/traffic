					...
					<nav>
						...
						<div class="top_tiles">
							<div class="col-md-3 tile">
								<span><?= Html::a(Yii::t('menu', 'Всего заработано'), \Yii::$app->request->BaseUrl.'/backoffice-content/total-profit', []); ?></span>
								<h2>
									0 - <span class="btc">btc</span>
								</h2>
							</div>
							<div class="col-md-3 tile">
								<span><?= Html::a(Yii::t('menu', 'Ожидаемый заработок'), \Yii::$app->request->BaseUrl.'/backoffice-content/up-to-profit', []); ?></span>
								<h2>0 - <span class="btc">btc</span></h2>
							</div>
							<div class="col-md-3 tile">
								<span><?= Html::a(Yii::t('menu', 'Бонус'), \Yii::$app->request->BaseUrl.'/backoffice-content/bonus', []); ?></span>
								<h2><?= (isset($this->params['register_bonus'])) ? $this->params['register_bonus'] : 0; ?>$</h2>
							</div>
							<div class="col-md-3 tile">
								<span><?= Html::a(Yii::t('menu', 'Токены'), \Yii::$app->request->BaseUrl.'/backoffice-content/tokens', []); ?></span>
								<h2><?= (isset($this->params['register_tokens'])) ? $this->params['register_tokens'] : 0; ?></h2>
							</div>
						</div>
