        ...
        <div class="card">
            <div class="card-body" style="padding: 20px;">
                ...
                <div class="form-group row">
                    <label for="top-leader-month" class="col-sm-3 col-form-label"><?= Yii::t('form', 'Заголовок'); ?></label>
                    <div class="col-sm-9">
						<?= $form->field($searchModel, 'title', [])->textInput(); ?>
                    </div>
                </div>
                <div class="form-group row">
                    <label for="top-leader-month" class="col-sm-3 col-form-label"><?= Yii::t('form', 'Ссылка'); ?></label>
                    <div class="col-sm-9">
			            <?= $form->field($searchModel, 'link', [])->textInput(); ?>
                    </div>
                </div>
