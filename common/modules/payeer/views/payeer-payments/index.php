...
$this->title = Yii::t('form', 'Список payeer операций');
...
<div class="payeer-payments">
	...
	<div class="filter-form">
		...
		<div class="selector">
			...
			<?= $form->field($searchModel, 'operation_id', [
			'template' => '<div class="col-md-4">
				<div class="controls">
					{label}{input}{hint}{error}
				</div>
		...
		<div class="selector">
			...
			'inputOptions' => []])->dropDownList($currencyList, ['prompt'=>'Выбрать', 'style'=>'width:200px;']); ?>
