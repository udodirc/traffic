				...
				<?= GridView::widget([
					...
					'columns' => [
						...
						[
							...
							{
								return Html::a(Yii::t('form', 'Запрос на вывод'), 'witdrawal-request?id='.$model->id.'&type=2');
							},
						],
						[
				...
				<?= GridView::widget([
					...
					'columns' => [
						...
						[
							...
							'value'=>function ($model) 
							{
								return Html::a(Yii::t('form', 'Запрос на вывод'), 'witdrawal-request?id='.$model->id.'&type=1');
							},
						],
						[
							'attribute' => 'created_at', 
