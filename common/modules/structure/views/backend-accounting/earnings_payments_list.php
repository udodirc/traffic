...
<div class="payments-invoices-index">
	...
	<div class="filter-form">
		<?php $form = ActiveForm::begin([
			'action'=>['earnings-payment-list?id='.$id],
			'method' => 'get',
			'id' => 'filter-form',
			'fieldConfig' => 
			[
        ...
        'columns' => [
            ...
            [
				...
				'buttons' => [
					...
					{
						return Html::a('<span class="glyphicon glyphicon-eye-open"></span>', \Yii::$app->request->BaseUrl.'/structure/backend-payments-invoices/view?id='.$model->id, ['target'=>'blank']);
					},
				]
			],
            //['class' => 'yii\grid\ActionColumn'],
