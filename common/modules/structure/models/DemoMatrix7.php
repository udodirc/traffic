...
/**
 * This is the model class for table "demo_matrix_7".
 *
 * @property integer $id
 * @property integer $matrix_id
 * @property integer $clone_matrix_id
 ...
 */
class DemoMatrix7 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return [
            [['matrix_id', 'clone_matrix_id', 'partner_id', 'parent_id', 'left_key', 'right_key', 'level', 'level_1', 'level_2', 'level_3', 'clone', 'open_date', 'close_date'], 'integer'],
            [['clone_matrix_id', 'clone'], 'required']
        ];
    }
    ...
    public function attributeLabels()
    {
        return [
            ...
            'clone_matrix_id' => Yii::t('form', 'Clone Matrix ID'),
