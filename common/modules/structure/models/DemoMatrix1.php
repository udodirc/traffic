...
/**
 * This is the model class for table "demo_matrix_1".
 *
 * @property integer $id
 ...
 *
 * @property DemoLevelsPayment[] $demoLevelsPayments
 * @property Partners $partner
 */
class DemoMatrix1 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
     ...
     */
    public function getDemoLevelsPayments()
    {
        return $this->hasMany(DemoLevelsPayment::className(), ['matrix_id' => 'id']);
    }
