...
/**
 * This is the model class for table "demo_levels_payment".
 *
 * @property integer $id
 ...
 *
 * @property DemoMatrix1 $matrix
 * @property Partners $partner
 * @property Partners $refferal
 */
class DemoLevelsPayment extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
    ...
    {
        return $this->hasOne(DemoMatrix1::className(), ['id' => 'matrix_id']);
    }
