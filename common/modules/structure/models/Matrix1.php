...
/**
 * This is the model class for table "matrix_1".
 *
 * @property integer $id
 ...
 *
 * @property LevelsPayment[] $levelsPayments
 * @property Partners $partner
 */
class Matrix1 extends \yii\db\ActiveRecord
{
    /**
     * @inheritdoc
     */
     ...
     */
    public function getLevelsPayments()
    {
        return $this->hasMany(LevelsPayment::className(), ['matrix_id' => 'id']);
    }
