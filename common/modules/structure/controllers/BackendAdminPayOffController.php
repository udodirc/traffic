...
/**
 * BackendAdminPayOffController implements the CRUD actions for AdminPayOff model.
 */
class BackendAdminPayOffController extends Controller
{
    ...
    */
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new AdminPayOffSearch();
