...
use common\modules\structure\models\AutoPayOffLogsSearch;
use common\modules\structure\models\Payment;

/**
 * AutoPayOffLogs controller for the `structure` module
 */
class AutoPayOffLogsController extends Controller
{
    ...
    */
    ...
    public function actionIndex()
    {
        ...
        $searchModel = new AutoPayOffLogsSearch();
        $dataProvider = $searchModel->search(Yii::$app->request->queryParams);
        $structuresList = (isset(\Yii::$app->params['structures'])) ? \Yii::$app->params['structures'] : [];
        $paymentTypeList = AutoPayOffLogs::getPaymentTypeList();
        $payOffList = AutoPayOffLogs::getPayOffList();
    ...
    public function actionMarkPayOff($id)
    {
		...
		$result = AutoPayOffLogs::updatePaidOff($id);
