...
return [
	...
	<p>С уважением, служба поддержки. <br/><a  style="color:#002857;" href="{site}">{site}</a></p>' 
		=> 
	'<p>Hello, <span style="color:#002857;">{first_name}&nbsp;{last_name}</span></p>
	<p>Remember your registered info:</p>
	<p><b>Login:</b> <span style="color:#002857;">{login}</span></p>
	<p><b>E-mail:</b> <span style="color:#002857;">{email}</span></p>
	<p>For confirmation of password, click by link&nbsp;<a href="{site}/confirm/{partner_id}/{auth_key}">{site}/confirm/{partner_id}/{auth_key}</a></p>
	<br/>
	<p>With regard, support. <br/><a  style="color:#002857;" href="{site}">{site}</a></p>',
];
