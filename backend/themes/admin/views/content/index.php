    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            [
				...
				'filterInputOptions'=>['name' => 'ContentSearch[controller_id]'],
				'content'=>function($model) use ($controlerList) 
				{
					return isset($controlerList[$model->controller_id]) ? $controlerList[$model->controller_id] : '';
                }
			],
            'title',
            [
